...
val bugFinderArray = ["f569ad78-faef-4c17-8b07-e8ad0ff79a71", "467a4aaf-5343-41f7-8f1f-abf25ea37863"] as string[];
...
Recipes.addShaped("developer", <wearablebackpacks:backpack>.withTag({Unbreakable: 1, backpack: {armor: 6, size: [14, 2]}, display: {Lore: ["A special backpack given to members of the development team!"], color: 11546150, Name: "Developer's Backpack"}}), [[<minecraft:leather>, <minecraft:diamond>, <minecraft:leather>],[<minecraft:leather>, <minecraft:wool:*>, <minecraft:leather>], [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]]);
...
Recipes.addShaped("alpha_tester", <wearablebackpacks:backpack>.withTag({backpack: {armor: 4, size: [12, 2]}, display: {Lore: ["A special backpack given to players who helped test Project Towny in it's alpha days!"], color: 15368089, Name: "Alpha Tester's Backpack"}}), [[<minecraft:leather>, <minecraft:diamond>, <minecraft:leather>],[<minecraft:leather>, <minecraft:wool:*>, <minecraft:leather>], [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]]);
...
Recipes.addShaped("builder", <wearablebackpacks:backpack>.withTag({backpack: {armor: 4, size: [12, 2]}, display: {Lore: ["A special backpack given to players who helped build buildings for Project Towny!"], color: 3837642, Name: "Builder's Backpack"}}), [[<minecraft:leather>, <minecraft:diamond>, <minecraft:leather>],[<minecraft:leather>, <minecraft:wool:*>, <minecraft:leather>], [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]]);
...
Recipes.addShaped("bug_finder", <wearablebackpacks:backpack>.withTag({backpack: {armor: 4, size: [12, 2]}, display: {Lore: ["A special backpack given to players who reported major gamebreaking bugs!"], color: 8991416, Name: "Bug Finders's Backpack"}}), [[<minecraft:leather>, <minecraft:diamond>, <minecraft:leather>],[<minecraft:leather>, <minecraft:wool:*>, <minecraft:leather>], [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]]);
