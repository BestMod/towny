...
var transistor = RecipeBuilder.newBuilder("transistor", "microchip_inscriber", 1200);
...
var microchip1 = RecipeBuilder.newBuilder("microchip1", "microchip_inscriber", 1200);
...
alu.addItemInput(<ore:nuggetIron>, 36);
...
dram.addItemOutput(<contenttweaker:dram>);
