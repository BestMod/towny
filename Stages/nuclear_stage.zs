...
mods.orestages.OreStages.addReplacement("nuclear_stage", <geolosys:ore:9>); // Hides Uranium
mods.orestages.OreStages.addReplacement("nuclear_stage", <nuclearcraft:ore:6>); // Hides Lithium
